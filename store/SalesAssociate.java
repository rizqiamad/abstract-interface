...
public class SalesAssociate extends AbstractStoreEmployee {
    ...
    public SalesAssociate(double salesRate, double numberOfHoursWorked, double hourlyRate,
            String storeDetails, String associateName, double basePay, String birthDay, byte yearWorking, String feelling) {
        super(numberOfHoursWorked, hourlyRate, storeDetails, basePay, associateName, birthDay, yearWorking, feelling);
