...
public abstract class AbstractStoreEmployee implements Employee, Store {
   ...
   * new Abstract method
   */
  public abstract String feelling();
  ...
  /**
   * Override birthDay method
   */
  @Override
  public abstract String birthDay();

  /**
   * Override yearWorking method
   */
  @Override
  public abstract byte yearWorking();
