...
public class Manager extends AbstractStoreEmployee {
    ...
    public Manager(double totalStoreSales, double salesDone, double numberOfHoursWorked,
            double hourlyRate, String storeDetails, double basePay, String name, String birthDay, byte yearWorking, String feelling) {
        super(numberOfHoursWorked, hourlyRate, storeDetails, basePay, name, birthDay, yearWorking, feelling);
